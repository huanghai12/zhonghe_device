...
export default function Home() {
  ...
  function getRobotInfo(){
    status_list().then(res => {
      ...
      list.map((item: any,index: any) => {
        if((item.id > 0 && item.id < 5) || item.id == 8 || item.id == 9){
          arr2.push(item);
        }else if(item.id == 5 ){
          arr1.push(item);
  ...
  return (
            <div className="content" >
              <div className='con1' style={{width: '326px', height: '100%',marginRight: '30px',display: data.length > 0 ? 'flex' : 'block'}}>
                <div  style={{paddingTop: '36px',paddingBottom: data.length > 0 ? '' : '36px'}}>
              ...
              <div className='con1' style={{width: '683px', height: '100%',marginRight: '30px'}}>
              ...
              <div className='con3' style={{width: '259px', height: '100%',marginRight: '30px'}}>
                {data2.length > 0 &&data2.map((item: any) => {
                    return (
                        <div style={{width: '259px',marginBottom: 20}} key={item.id}>
                          <Boxs1 width={258} item={item}></Boxs1>
                        </div>
                    )
                  })}
              </div>
              <div className='con2' style={{width: '470px', height: '100%'}}>
